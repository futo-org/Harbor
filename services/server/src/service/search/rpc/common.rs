...
use crate::service::proto::{
    self, EventBundle, EventHint, PageParams, SortUsersBy,
};
...
pub struct SearchResponseFilter {
...
impl Marker {
    pub fn matches(&self, sort_by: SortUsersBy) -> bool {
        match self.sorted_by {
            SortedBy::Rank(_) => sort_by == SortUsersBy::Default,
            SortedBy::Name(_) => sort_by == SortUsersBy::Alpha,
        }
    }
}
