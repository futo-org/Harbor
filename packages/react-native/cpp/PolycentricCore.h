...
extern "C" {
    ...
    CBuffer query_author_feed(CBuffer system, CBuffer author, CBuffer network_requests, unsigned long limit, CBuffer cursor);
    ...
    CBuffer query_following_feed(CBuffer system, unsigned long limit, CBuffer cursor);
    CBuffer query_likes_feed(CBuffer system, unsigned long limit, CBuffer cursor);
...
public:
    ...
    jsi::Object queryAuthorFeed(jsi::Runtime& rt, jsi::Object system, jsi::Object author, jsi::Object networkRequests, double limit, jsi::Object cursor);
    ...
    jsi::Object queryFollowingFeed(jsi::Runtime& rt, jsi::Object system, double limit, jsi::Object cursor);
    jsi::Object queryLikesFeed(jsi::Runtime& rt, jsi::Object system, double limit, jsi::Object cursor);
