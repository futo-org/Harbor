...
interface NativeModuleInterface {
  ...
  ubrn_uniffi_polycentric_core_fn_method_polycentriccore_sync_to_server(
    ptr: bigint,
    identity: Uint8Array,
    server: Uint8Array
  ): bigint;
  ...
  ubrn_uniffi_polycentric_core_checksum_method_polycentriccore_sync_to_server(): number;
