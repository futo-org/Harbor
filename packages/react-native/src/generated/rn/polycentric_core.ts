  ...
  async syncToServer(
    ...
    try {
      return await uniffiRustCallAsync(
        /*rustCaller:*/ uniffiCaller,
        /*rustFutureFunc:*/ () => {
          return nativeModule().ubrn_uniffi_polycentric_core_fn_method_polycentriccore_sync_to_server(
            uniffiTypePolycentricCoreObjectFactory.clonePointer(this),
            FfiConverterString.lower(identity),
...
function uniffiEnsureInitialized() {
  ...
  if (
    nativeModule().ubrn_uniffi_polycentric_core_checksum_method_polycentriccore_sync_to_server() !==
    15341
  ) {
    throw new UniffiInternalError.ApiChecksumMismatch(
      'uniffi_polycentric_core_checksum_method_polycentriccore_sync_to_server'
    );
  }
  if (
