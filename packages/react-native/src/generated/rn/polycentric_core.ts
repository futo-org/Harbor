 ...
 * authorize `pubic_key` as a new rotation key for the identity.
...
function uniffiEnsureInitialized() {
    ...
    if (nativeModule().ubrn_uniffi_polycentric_core_checksum_method_polycentriccore_assemble_recovery_payload() !== 30469) {
