...
export const IconsMap = {
  ...
  emoticonHappyOutline: defineIcon(
    MaterialCommunityIcons,
    'emoticon-happy-outline',
  ),
  flag: defineIcon(Ionicons, 'flag-outline'),
  flagOutline: defineIcon(MaterialCommunityIcons, 'flag-outline'),
  foodAppleOutline: defineIcon(MaterialCommunityIcons, 'food-apple-outline'),
  form: defineIcon(MaterialCommunityIcons, 'form-select'),
  handWaveOutline: defineIcon(MaterialCommunityIcons, 'hand-wave-outline'),
  ...
  lightbulbVariantOutline: defineIcon(
    MaterialCommunityIcons,
